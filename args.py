...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        #             default='/root/ESANet/result/nyuv2/nyuv2/nyuv2/ResNet_34_AdamW_finetune/ckpt_epoch_278.pth',
        #             type=str,
        ...
        self.add_argument('--batch_size_valid', type=int, default=1,
        ...
        self.add_argument('--weight_decay', '--wd', default=0.01, type=float,
                          help='weight decay')
        # self.add_argument('--weight_decay', '--wd', default=0.0001, type=float,
        #                   help='weight decay')
        self.add_argument('--momentum', default=0.9, type=float, metavar='M',
                          help='momentum')
        self.add_argument('--optimizer', type=str, default='AdamW',
        ...
        self.add_argument('--fuse_depth_in_rgb_encoder', default='FeatureRectifyModule',
                          choices=['SE-add', 'None', 'FeatureRectifyModule'],
        ...
        self.add_argument('--aug_scale_min', default=0.5, type=float,
                          help='the minimum scale for random rescaling the '
                               'training data.')
        self.add_argument('--aug_scale_max', default=1.75, type=float,
